...
export default {
    ...
    actions:{
        ...
        async getDatasCheck({dispatch, commit, state}, p=[]){
            dispatch("getDatas")
        },
        ...
        async top({dispatch, commit, state}, ids){
            let res:any = await req.ajax({
                method: "post",
                url: `/suggest/setTopSuggest`,
                body: ids || []
            })
        ...
        async noTop({dispatch, commit, state}, ids){
            let res:any = await req.ajax({
                method: "post",
                url: `/suggest/deleteTopSuggest`,
                body: ids || []
            })
        ...
        async deleteSelectionSuggest({dispatch, commit, state}, id){
            let res:any = await req.ajax({
                method: "get",
                url: `/suggest/deleteSelectionSuggest/${id}`,
                body:{}
            })
